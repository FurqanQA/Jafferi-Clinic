...
import { registerSchema, type RegisterFormData } from "@/lib/validation/register";
          ...
          <div className="space-y-3">
            <label className="flex items-start gap-3 cursor-pointer">
              <input
                ...
                disabled={isSubmitting}
                className="mt-0.5 size-4 rounded border-slate-300 text-emerald-600 focus:ring-emerald-500 focus:ring-offset-0"
              />
